...
Нужен Node 18+. В корне репо один раз: `npm ci`.
...
кладёт на сайт со своего домена — читатель не зависит от доступности Steam CDN.
...
`node scripts/new.mjs 668580 --slug atomic-heart-2024`. Связки «дропнул в 2024 ↗ / вернулся и прошёл ↗»
...
Дизайн — вариант «Свиток», победитель пяти итераций прототипа
